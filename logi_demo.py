...
def image_stream(sub: Subscriber, calib, stride):
    """image generator"""
...
if __name__ == "__main__":
    ...
    sub.connect()
    print(f"Subscriber connected to stream: {STREAM_NAME}")
    print("Press 'q' in the OpenCV window to quit.")
    for t, image, intrinsics in image_stream(sub, args.calib, args.stride):
        if t < args.t0:
            continue
    ...
    traj_est = droid.terminate(image_stream(sub, args.calib, args.stride))
